...
@property (nonatomic) NSInteger score;
@property (nonatomic, readonly) CGFloat scoreTextScaler;
...
SWIFT_CLASS("_TtC19SpaceInvadersMobile18GameViewController")
...
- (void)respawn;
- (void)fireBulletWithScene:(SKScene * _Nonnull)scene;
- (NSInteger)getPlayersLives SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isPlayerInvincible SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(UIColor * _Nonnull)color size:(CGSize)size SWIFT_UNAVAILABLE;
@end
